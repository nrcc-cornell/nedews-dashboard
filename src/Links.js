...
export default class Links extends Component { 
  constructor (props) {
    ...
    this.linkKeys = ["usdm","ahps","nc-ahps","dmmaps","blends","nrcc-kbdi","usgs-sf","usgs-gw","nhdes-gw","hprcc-acis","qdri","vdri","eddi","sport","grace","nldas","vic","cpc-sm","cpc-pdsi","cpc-topsoil","cpc-blends",
